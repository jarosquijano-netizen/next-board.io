...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed left-0 top-0 h-screen w-64 bg-gradient-to-b from-white to-gray-50 dark:from-slate-900 dark:to-slate-800 border-r border-gray-200 dark:border-slate-700 flex flex-col z-50 transform transition-all duration-300 ease-in-out ${
      ...
      <nav className="flex-1 px-4 py-6 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 mt-4 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg shadow-blue-500/30 touch-manipulation active:scale-95"
        >
      ...
      <div className="p-4 border-t border-gray-200 dark:border-slate-700">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-gray-100 dark:bg-slate-800/50 text-gray-600 dark:text-slate-400 hover:bg-gray-200 dark:hover:bg-slate-700 transition-all duration-300 active:scale-95 border-2 border-transparent hover:border-blue-500"
