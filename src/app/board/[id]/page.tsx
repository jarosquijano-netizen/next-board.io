                    ...
                    {COLUMNS.map((column) => {
                      ...
                      return (
                        <div key={column.id} className="flex flex-col relative">
                          ...
                          <div className={`sticky ${isSearchFiltersVisible && ((viewMode === 'kanban' && layoutMode === 'top') || viewMode === 'calendar') ? 'top-[350px]' : 'top-[140px]'} z-[5] bg-gradient-to-r ${column.color} rounded-lg p-3 mb-3 shadow-lg backdrop-blur-sm transition-all duration-300 pointer-events-auto`}>
                            <div className="flex items-center justify-between mb-2">
