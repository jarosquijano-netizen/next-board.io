            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
              ...
              >
                ...
                <div className="text-left min-w-0 flex-1">
                  <h3 className="font-semibold text-sm text-gray-900 dark:text-white">New Board</h3>
              ...
              >
                ...
                <div className="text-left min-w-0 flex-1">
                  <h3 className="font-semibold text-sm text-gray-900 dark:text-white">All Boards</h3>
