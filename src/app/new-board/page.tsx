...
export default function NewBoard() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      {/* Main Content */}
      <div className="lg:ml-64 min-h-screen transition-colors duration-300">
        {/* Demo Mode Banner */}
        {DEMO_MODE && (
          <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 border-b border-amber-500/20 dark:border-amber-500/20">
        ...
        <div className="max-w-7xl mx-auto px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/5 border border-blue-500/20 dark:border-blue-500/20 rounded-xl p-6">
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/5 border border-purple-500/20 dark:border-purple-500/20 rounded-xl p-6">
              <div className="flex items-center gap-4">
            ...
            <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/5 border border-emerald-500/20 dark:border-emerald-500/20 rounded-xl p-6">
              <div className="flex items-center gap-4">
          ...
          {/* Upload Panel */}
          <div className="bg-white dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 rounded-2xl p-8 transition-colors duration-300">
            <UploadPanel onProcessComplete={handleProcessComplete} />
          </div>

          {/* Features */}
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-50 dark:bg-slate-900/30 border border-gray-200 dark:border-slate-800 rounded-xl p-6 transition-colors duration-300">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">What NextBoard Does</h3>
            ...
            <div className="bg-gray-50 dark:bg-slate-900/30 border border-gray-200 dark:border-slate-800 rounded-xl p-6 transition-colors duration-300">
              ...
              <div className="grid grid-cols-2 gap-3">
                {['MP3', 'MP4', 'WAV', 'TXT', 'VTT', 'DOCX'].map((format) => (
                  <div key={format} className="px-3 py-2 bg-white dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-lg text-center transition-colors duration-300">
